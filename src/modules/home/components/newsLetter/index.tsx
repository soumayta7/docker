...
const Hero = () => {
 ...
 <div className="mt-6  ">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="subsinput min-w-0 flex-auto r  border-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:red sm:text-sm sm:leading-6"
